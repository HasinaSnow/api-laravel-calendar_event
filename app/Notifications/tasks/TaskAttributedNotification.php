...
class TaskAttributedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        $message = ($notifiable->id === $this->taskAttributeRequest->attribute_to) ? 
            '"' . $user . '" assigned you the new task "' . $this->task->name . '"  for the event ' . $this->event->date . '.' :
            '"' . $user . '" assigned the new task "' . $this->task->name  . '" to ' . User::find($this->taskAttributeRequest->attribute_to)->name . ' for the event ' . $this->event->date . '.';
